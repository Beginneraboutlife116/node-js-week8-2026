 ...
 */
module.exports = class Init1788101697933 {
    name = 'Init1788101697933'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "COURSE" ADD CONSTRAINT "course_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "USER"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "COURSE" ADD CONSTRAINT "course_skill_id_fk" FOREIGN KEY ("skill_id") REFERENCES "SKILL"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
    ...
    async down(queryRunner) {
        await queryRunner.query(`ALTER TABLE "COURSE" DROP CONSTRAINT "course_skill_id_fk"`);
        await queryRunner.query(`ALTER TABLE "COURSE" DROP CONSTRAINT "course_user_id_fk"`);
